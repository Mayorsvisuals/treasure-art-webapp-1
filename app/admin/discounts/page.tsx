...
export default function AdminDiscountsPage() {
  return (
    <div className="pb-16 flex flex-col items-center justify-center min-h-[50vh] text-center">
      ...
      <h1 className="font-serif text-3xl text-luxury-paper mb-2">Discounts</h1>
      <p className="text-gray-400 font-light text-sm max-w-md mx-auto">This section is currently under development. Here you will be able to manage discount codes and promotions.</p>
    </div>
  );
}
